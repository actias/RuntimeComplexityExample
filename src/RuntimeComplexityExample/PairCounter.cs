...
namespace RuntimeComplexityExample
{
    public class PairCounter
    {
        ...
        // Bug 1) Function was not public so the function could not be reached from outside the class. This wouldn't necessarily be a problem except that this is the only function in the class so having a class with a private function is a bit odd.
